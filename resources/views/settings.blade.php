...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="dark">
        ...
        <div class="pc-content">
            ...
            <div class="settings-wrap">
                <div class="settings-head">
                    <div>
                        <h2 style="margin:0; font-weight:800;">Settings</h2>
                        <small class="text-secondary">Read-only demo settings for the hackathon pitch</small>
                    </div>
                    <div style="display:flex; gap:8px; flex-wrap:wrap;">
                        <span class="badge-soft"><i class="ti ti-shield-check"></i> Demo mode</span>
                        <span class="badge-soft"><i class="ti ti-device-desktop-analytics"></i> v1.0</span>
                    </div>
                </div>
                ...
                <div class="grid-2">
                    ...
                    <div style="display:grid; gap:16px;">
                        ...
                        <div class="section-card">
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" class="form-control" value="Hackathon User" disabled>
                            </div>
                            <div class="form-row">
                                <label class="muted">Email</label>
                                <input type="email" class="form-control" value="user@armagedon.app" disabled>
                            </div>
                            <div class="form-row">
                                <label class="muted">Role</label>
                                <input type="text" class="form-control" value="Viewer" disabled>
                            </div>
                        </div>
                        ...
                        <div class="section-card">
                            ...
                            <div class="form-row">
                                ...
                                <div class="switch">
                                    <input type="radio" name="theme" id="thDark" checked>
                                    <label for="thDark" class="muted">Dark</label>
                                    <input type="radio" name="theme" id="thLight" style="margin-left:16px;">
                                    <label for="thLight" class="muted">Light</label>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="sep"></div>
                            <button class="btn-ghost" id="btnSaveA"><i class="ti ti-device-floppy"></i> Save
                                appearance</button>
                        </div>
                        ...
                        <div class="section-card">
                            ...
                            <div class="form-row">
                                <label class="muted">NASA API</label>
                                <div class="switch">
                                    <input type="checkbox" id="swNasa" checked>
                                    <label for="swNasa" class="muted">Enable NeoWs feed</label>
                                </div>
                            </div>
                            <div class="form-row">
                                <label class="muted">NASA API Key</label>
                                <input type="text" class="form-control api-mask" id="apiNasa"
                                    value="3hfOk8BaLvLnnzP2ArAyVL3W••••••••••••" disabled>
                            </div>
                            <div class="form-row">
                                <label class="muted">USGS</label>
                                <div class="switch">
                                    <input type="checkbox" id="swUsgs">
                                    <label for="swUsgs" class="muted">Enable layers (tsunami, seismicity,
                                        DEM)</label>
                                </div>
                            </div>
                            <div class="sep"></div>
                            <button class="btn-ghost" id="btnSaveD"><i class="ti ti-device-floppy"></i> Save
                                data</button>
                        </div>
                        ...
                        <div class="section-card">
                            ...
                            <div class="form-row">
                                ...
                                <select class="form-control" id="unitsSel">
                                    <option selected>Metric (m, km/s, MT)</option>
                                    <option>Imperial (ft, mi/s, kt)</option>
                                </select>
                            </div>
                            <div class="form-row">
                                <label class="muted">Default density</label>
                                <input type="number" class="form-control" value="3000" min="500"
                                    max="8000">
                            </div>
                            <div class="form-row">
                                <label class="muted">Max fragments</label>
                                <input type="number" class="form-control" value="16" min="2"
                                    max="64">
                            </div>
                            <div class="sep"></div>
                            <button class="btn-ghost" id="btnSaveS"><i class="ti ti-device-floppy"></i> Save
                                simulation</button>
                        </div>
                        ...
                        <div class="section-card">
                            ...
                            <div class="form-row">
                                <label class="muted">Daily digest</label>
                                <div class="switch">
                                    <input type="checkbox" id="swDaily" checked>
                                    <label for="swDaily" class="muted">Send daily NEO summary</label>
                                </div>
                            </div>
                            <div class="form-row">
                                <label class="muted">Critical alerts</label>
                                <div class="switch">
                                    <input type="checkbox" id="swCritical" checked>
                                    <label for="swCritical" class="muted">Notify on potentially hazardous
                                        NEOs</label>
                                </div>
                            </div>
                            <div class="sep"></div>
                            <button class="btn-ghost" id="btnSaveN"><i class="ti ti-device-floppy"></i> Save
                        ...
                        <div class="section-card">
                            ...
                            <p class="muted" style="margin-top:6px;">These actions are irreversible in a real app.
                                For demo, they only show a confirmation.</p>
                            <div style="display:flex; gap:10px; flex-wrap:wrap;">
                                <button class="btn-danger" id="btnReset"><i class="ti ti-eraser"></i> Reset demo
                                    state</button>
                                <button class="btn-danger" id="btnClear"><i class="ti ti-trash"></i> Clear local
                                    cache</button>
                            </div>
                        </div>
                    ...
                    <div class="section-card">
                        ...
                        <ul style="margin:0; padding-left:18px; line-height:1.9;">
                            <li><b>Theme:</b> Dark</li>
                            <li><b>NASA NeoWs:</b> Enabled</li>
                            <li><b>USGS Layers:</b> Off</li>
                            <li><b>Units:</b> Metric</li>
                            <li><b>Default density:</b> 3000 kg/m³</li>
                            <li><b>Daily digest:</b> On</li>
                            <li><b>Critical alerts:</b> On</li>
                        </ul>
                        <hr class="sep" style="margin:14px 0;">
                        <small class="muted">Note: This is a static summary for the presentation.</small>
                    </div>
                </div>
            </div>

            <div class="toast-save" id="toastSave"><i class="ti ti-check"></i> Saved</div>
        </div>
    </div>
    ...
    <script>
        // simple demo toasts (no persistence)
        ...
        document.getElementById('btnSaveA').addEventListener('click', () => showToast('Appearance saved'));
        document.getElementById('btnSaveD').addEventListener('click', () => showToast('Data source settings saved'));
        document.getElementById('btnSaveS').addEventListener('click', () => showToast('Simulation settings saved'));
        document.getElementById('btnSaveN').addEventListener('click', () => showToast('Notifications saved'));
        document.getElementById('btnReset').addEventListener('click', () => showToast('Demo state reset'));
        document.getElementById('btnClear').addEventListener('click', () => showToast('Local cache cleared'));
    </script>
